...
![Landing page for Voyant](../assets/dsc6-voyant-landing.png)
...
![Uploading corpus](../assets/dsc6_upload.png)

![Upload 15% complete](../assets/dsc6_uploading15.png)
...
![Upload 68% complete](../assets/dsc6_uploading68.png)
...
![Upload 89% complete](../assets/dsc6_uploading89.png)
...
![Default Voyant interface with corpus](../assets/dsc6_voyant-tools-1.png)
...
![Document stats table in Voyant](../assets/dsc6_documents.png)
...
![Cirrus header](../assets/dsc6_cirrus-header.png)
...
![Documents header](../assets/dsc6_documents-header.png)
...
![Cirrus with automatic stopwords](../assets/dsc6_cirrus-autostopwords.png)![Cirrus with no stopwords](../assets/dsc6_cirrus-nostopwords.png)
...
![Cirrus header with menu items](../assets/dsc6_cirrus-header.png)
...
![Cirrus configuration options](../assets/dsc6_cirrus-options.png)
...
![Cirrus configuration options](../assets/dsc6_whitelist-names.png)
...
![Stop trying to make 'fetch' happen](../assets/dsc6_fetch.gif)
...
![Slang whitelist](../assets/dsc6_whitelist-slang.png)
...
![Terms table](../assets/dsc6_terms-default.png)
...
![Terms help page](../assets/dsc6_terms-help.png)
...
![Term count](../assets/dsc6_terms-dibble.png)
...
![Contexts for fresh](../assets/dsc6_contexts-fresh.png)
...
![Reader interface with 'fresh' examples](../assets/dsc6_reader-fresh.png)
...
![Reader interface with 'fresh' examples](../assets/dsc6_mystery-admirer-fresh.png)
...
![Trends interface for slang terms](../assets/dsc6_trends-slang.png)

It’s pretty cramped and cuts off a bit, so I drag the edges of the tool and resize so I can see more of it. 

![Resized trends interface for slang terms](../assets/dsc6_trends-resized.png)
...
![Usage trends for 'dibble' words](../assets/dsc6_dibble-trends.png)
...
![Fashion description with 'dibble'](../assets/dsc6_dibble-contexts-41.png)
...
![Links showing 'cool' in the center of the network diagram](../assets/dsc6_links-cool.png)
...
![Frequency visualization with "cool" bigger than all other slang terms](../assets/dsc6_cool-trends.png)
...
![Description of Scatterplot tool](../assets/dsc6_scatterplot.png)
![Description of terms radio tool](../assets/dsc6_terms-radio.png)
![Description of topics tool](../assets/dsc6_topics.png)
...
![Voyant export options](../assets/dsc6_export-option.png)
